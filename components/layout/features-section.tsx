...
function getIcon(name: string) {
  switch (name) {
    case "CLOCK_ICON":
      return <ClockIcon className="mb-4 h-12 w-12 text-gray-900" />;
    case "CHECK_ICON":
      return <CheckIcon className="mb-4 h-12 w-12 text-gray-900" />;
    case "CLOUD_ICON":
      return <CloudIcon className="mb-4 h-12 w-12 text-gray-900" />;
    default:
      return null;
  }
}
